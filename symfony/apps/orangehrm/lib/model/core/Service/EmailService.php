...
class EmailService extends BaseService {
    ...
    public function sendEmailUsingTemplate( $emailName , $info , $to) {
        ...
        elseif( $emailName == 'approvedExpenseReport'){
            $templateSubject = 'orangehrmExpensePlugin/modules/expense/mail/en_US/AppprovedExpenseReportMail/ApprovdExpenseReportSubject.txt';
            $templateBody    = 'orangehrmExpensePlugin/modules/expense/mail/en_US/AppprovedExpenseReportMail/ApprovdExpenseReportBody.txt';
            $logMessage = "Submitted expense report status was sent to(expense reporter)". $to;
        }
        elseif( $emailName == 'approvedExpenseReportToSup'){
            $templateSubject = 'orangehrmExpensePlugin/modules/expense/mail/en_US/AppprovedExpenseReportToSupMail/ApprovdExpenseReportToSupSubject.txt';
            $templateBody    = 'orangehrmExpensePlugin/modules/expense/mail/en_US/AppprovedExpenseReportToSupMail/ApprovdExpenseReportToSupBody.txt';
            $logMessage = "Submitted expense report status was sent to (manager)". $to;
        }
        elseif( $emailName == 'supapprovedExpenseReport'){
            $templateSubject = 'orangehrmExpensePlugin/modules/expense/mail/en_US/SupApprovedExpenseMail/SupApprovdExpenseSubject.txt';
            $templateBody    = 'orangehrmExpensePlugin/modules/expense/mail/en_US/SupApprovedExpenseMail/SupApprovdExpenseBody.txt';
            $logMessage = "Submitted expense report status was sent to(cost center admin)". $to;
        }elseif( $emailName == 'submittedByExpenseMail'){
            $templateSubject = 'orangehrmExpensePlugin/modules/expense/mail/en_US/SubmittedByExpenseMail/SubmittedByExpenseSubject.txt';
            $templateBody    = 'orangehrmExpensePlugin/modules/expense/mail/en_US/SubmittedByExpenseMail/SubmittedByExpenseBody.txt';
            $logMessage = "Email generated upon submission of expense. This email was sent to(expense reporter)". $to;
        }elseif( $emailName == 'submittedToExpenseMail'){
            $templateSubject = 'orangehrmExpensePlugin/modules/expense/mail/en_US/SubmittedToExpenseMail/SubmittedToExpenseSubject.txt';
            $templateBody    = 'orangehrmExpensePlugin/modules/expense/mail/en_US/SubmittedToExpenseMail/SubmittedToExpenseBody.txt';
            $logMessage = "Email generated upon submission of expense. This email was sent to(manager)". $to;
        }elseif( $emailName == 'commentedExpenseReport'){
            $templateSubject = 'orangehrmExpensePlugin/modules/expense/mail/en_US/CommentOnExpenseReportMail/CommentOnExpenseReportSubject.txt';
            $templateBody = 'orangehrmExpensePlugin/modules/expense/mail/en_US/CommentOnExpenseReportMail/CommentOnExpenseReportBody.txt';
            $logMessage = "Comment was made on the expense report. This email was sent to(expense reporter)". $to;
        }
        elseif( $emailName == 'supCommentedExpenseToManReport'){
            $templateSubject = 'orangehrmExpensePlugin/modules/expense/mail/en_US/SupCommentedExpenseToManMail/SupCommentedExpenseToManSubject.txt';
            $templateBody = 'orangehrmExpensePlugin/modules/expense/mail/en_US/SupCommentedExpenseToManMail/SupCommentedExpenseToManBody.txt';
            $logMessage = "Comment was made on the expense report. This email was sent to(cost center admin)". $to;
        }
        elseif( $emailName == 'supCommentedExpenseReport'){
            $templateSubject = 'orangehrmExpensePlugin/modules/expense/mail/en_US/SupCommentedExpenseMail/SupCommentedExpenseSubject.txt';
            $templateBody = 'orangehrmExpensePlugin/modules/expense/mail/en_US/SupCommentedExpenseMail/SupCommentedExpenseBody.txt';
            $logMessage = "Comment was made on the expense report. This email was sent to(manager)". $to;
        }
