$(document).ready(function() {
    ...
    $("#frmAddEmp").validate({
        rules: {
            ...
            'emp_work_email' : { email: true, required:true, onkeyup: 'if_invalid'},
            'joined_date': {
                required: true,
                valid_date: function() {
                    return {
        ...
        messages: {
            'employeeId': {required:  lang_employeeIdRequired },
            ...
            'emp_work_email': { required: lang_lastNameRequired, email: incorrectEmail},
            'joined_date':{
                required:"Required",
                valid_date: "Should be a valid date in yyyy-mm-dd format"
                },
