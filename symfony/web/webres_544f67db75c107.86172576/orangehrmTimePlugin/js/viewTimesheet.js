$(document).ready(function(){
                ...
                $.getJSON(url, function(data) {
                    ...
                    if(data[0]==2){
                        ...
                        $('form#createTimesheetForm').attr({
                            action:linkForViewTimesheet+"?&timesheetStartDateFromDropDown="+startDate[0]+"&employeeId="+employeeId+"&timeSheetAction="+timesheetAction
                        });
    ...
    $("#btnEdit").click(function(){
        $('form#timesheetFrm').attr({
            action:linkForEditTimesheet+"?employeeId="+employeeId+"&timesheetId="+timesheetId+"&actionName="+actionName+"&timeSheetAction="+timesheetAction
        });
    ...
    $("#btnSubmit").click(function(){
        $('form#timesheetFrm').attr({
            action:linkForViewTimesheet+"?act="+submitAction+"&timesheetStartDate="+date+"&employeeId="+employeeId+"&submitted="+true+"&updateActionLog="+true+"&timeSheetAction="+timesheetAction
        });
        $('form#timesheetFrm').submit();
    });
    ...
    $("#btnReset").click(function(){
        $('form#timesheetFrm').attr({
            action:linkForViewTimesheet+"?act="+resetAction+"&timesheetStartDate="+date+"&employeeId="+employeeId+"&updateActionLog="+true+"&resetAction="+true+"&timeSheetAction="+timesheetAction
        });
        $('form#timesheetFrm').submit();
    });
    ...
    $("#btnReject").click(function(){
        $('form#timesheetActionFrm').attr({
            action:linkForViewTimesheet+"?act="+rejectAction+"&timesheetStartDate="+date+"&employeeId="+employeeId+
                "&updateActionLog="+true+"&timeSheetAction="+timesheetAction
        });
...
function clicked(dropdown){
    ...
    location.href = linkForViewTimesheet+"?timesheetStartDateFromDropDown="+dates[0]+"&selectedIndex="+selectedIndex+"&employeeId="+employeeId+"&timeSheetAction="+timesheetAction;
}
