...
<div class="box pimPane" id="">
            ...
            <form id="frmEmpJobDetails" method="post" enctype="multipart/form-data" action="<?php echo url_for('pim/viewJobDetails'); ?>">
                <fieldset>
                    ...
                    <ol>
                        ...
                        <li>
                            <?php echo $form['joined_date']->renderLabel(__('Date of Joining')); ?>
                        ...
                        <li>
                            <?php echo $form['emp_confirmation']->renderLabel(__('Employee Confirmation')); ?>
                            <?php echo $form['emp_confirmation']->render(array("class" => "formSelect")); ?>    
                        </li>
                    </ol>
                    <?php endif; ?>
                    ...
                    <p>
                        ...
                        $subordintors= $form->subordintors;
                        $allowed = FALSE;
                        ...
                        <?php  if ($subordintors==0) { ?>
                        <a id="terminateModal" class="btn2" data-toggle="modal" href="#terminateEmployement" target="_blank"></a>
                        
                        <?php } else { ?>
                            <a id="terminateModal" class="btn2" data-toggle="modal" href="#terminateEmployementConfirmation" target="_blank"></a>
                        <?php } ?>
                        <?php } ?>
    ...
    echo include_component('pim', 'customFields', array('empNumber' => $empNumber, 'screen' => CustomField::SCREEN_JOB)); 
        ...
        if (($_SESSION['userRole'] !="Team Lead") || ($_SESSION['empNumber']==$empNumber))
        {
...
<!--  Fixd the issue of termination by adding the code back in same place -->
<div class="modal hide" id="terminateEmployementConfirmation">
    <div class="modal-header">
        <a class="close" data-dismiss="modal">×</a>
        <h3><?php echo __('Terminate Employment Warning') ?></h3>
    </div>
    <div class="modal-body">
        <form id="frmTerminateEmployement" method="post" 
              action="<?php echo url_for('pim/terminateEmployement?empNumber=' . $empNumber.'&terminatedId='.$terminatedId); ?>">
            ...
            <fieldset>
             <ol>
             <li>
              This employee having Subordinate(s).<br>
                 Please remove all Subordinate(s) before Terminating.
    ...
    <div class="modal-footer">
        ...
        <input type="button"  id="dialogCancel" name="dialogCancel" class="btn"  data-dismiss="modal" value="<?php echo __('OK'); ?>" />
    </div>
</div>
