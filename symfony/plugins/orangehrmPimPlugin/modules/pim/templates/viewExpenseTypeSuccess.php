...
<?php 
$breadcrumb[]['name']='Expense Type'; 
$breadcrumb[]['link']=null;
include_partial('core/breadcrumb_page', array('breadcrumb' => $breadcrumb)); ?>

<?php use_javascript(plugin_web_path('orangehrmPimPlugin', 'js/viewExpenseTypeSuccess')); ?>

<div id="saveFormDiv" class="box">
    
    <div class="head">
        <h1 id="saveFormHeading">Add Expense Type</h1>
    </div>
    
    <div class="inner">

        <form name="frmSave" id="frmSave" method="post" action="<?php echo url_for('pim/viewExpenseType'); ?>">
...
<div id="recordsListDiv" class="box miniList">
    ...
    <div class="head">
        <h1><?php echo __('Expense Type'); ?></h1>
    </div>
    ...
    <div class="inner">
        ...
        <form name="frmList" id="frmList" method="post" action="<?php echo url_for('pim/deleteExpenseType'); ?>">
            <?php echo $listForm ?>
            <fieldset>
                <p id="listActions">
...
//<![CDATA[	    
    ...
    var recordKeyId = "expenseType_id";
   
    var saveFormFieldIds = new Array();
    saveFormFieldIds[0] = "expenseType_name";
    
    var urlForExistingNameCheck = '<?php echo url_for('pim/checkExpenseTypeNameExistence'); ?>';
    
    var lang_addFormHeading = "<?php echo __('Add Expense Type'); ?>";
    var lang_editFormHeading = "<?php echo __('Edit Expense Type'); ?>";
