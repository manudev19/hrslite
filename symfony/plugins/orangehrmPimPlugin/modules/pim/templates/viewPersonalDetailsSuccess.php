<?php 
 $breadcrumb[]['name']='Personal Details';
            ...
            <form id="frmEmpPersonalDetails" method="post" action="<?php echo url_for('pim/viewPersonalDetails'); ?>">
                ...
                <fieldset>
                    ...
                    <ol>
						...
						<li>
                            <?php echo $form['emp_aadhaar_num']->renderLabel(__('Aadhaar Number')); ?>
                            <?php echo $form['emp_aadhaar_num']->render(array("maxlength" => 30, "class" => "editable")); ?>    
                        </li>
                        <li>
                            <?php echo $form['emp_pan_num']->renderLabel(__('PAN Number')); ?>
                            <?php echo $form['emp_pan_num']->render(array("maxlength" => 30, "class" => "editable")); ?>    
                        </li>
                        <li>
                            <?php echo $form['emp_account_num']->renderLabel(__('Account Number')); ?>
                            <?php echo $form['emp_account_num']->render(array("maxlength" => 30, "class" => "editable")); ?>    
                        </li>
                        <?php if ($showSSN) : ?>
                        <li class="new">
                    ...
                    <?php endif; ?>                        
                    <?php if (isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] == "Yes" && ($_SESSION['empNumber']!=$empNumber)) {
