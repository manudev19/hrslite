<?php 
 $breadcrumb[]['name']='Qualifications';
...
<!--    
    ...
    <?php if(isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] == "Yes" && ($_SESSION['empNumber']!=$empNumber)) {
        if ($workExperiencePermissions->canCreate() || ($haveWorkExperience && $workExperiencePermissions->canUpdate())) { ?>
            ...
            <?php if ($workExperiencePermissions->canRead()) : ?>
                ...
                <form id="frmDelWorkExperience" action="<?php echo url_for('pim/saveDeleteWorkExperience?empNumber=' . 
                    ...
                    <p id="actionWorkExperience">
                        <?php if (isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] == "Yes" && ($_SESSION['empNumber']!=$empNumber)) { 
                        if ($workExperiencePermissions->canCreate() ) { ?>
                    ...
                    <table id="" class="table hover">
                        <thead>
                            <tr>
                                <?php
                                 if(isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] == "Yes" && ($_SESSION['empNumber']!=$empNumber)) {
                                 if ($workExperiencePermissions->canDelete()) { ?>
