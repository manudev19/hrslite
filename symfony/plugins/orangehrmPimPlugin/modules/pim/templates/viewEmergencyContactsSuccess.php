...
?>
 <?php 
 $breadcrumb[]['name']='Emergency Contacts';
...
<div class="box pimPane">
    ...
    if ($emergencyContactPermissions->canCreate() || ($haveContacts && $emergencyContactPermissions->canUpdate())) { ?>
    ...
    <div class="miniList" id="listEmegrencyContact">
        ...
        <div class="inner">
            ...
            <form name="frmEmpDelEmgContacts" id="frmEmpDelEmgContacts" method="post" action="<?php echo url_for('pim/deleteEmergencyContacts?empNumber=' . $empNumber); ?>">
                ...
                <p id="listActions">
                    <?php if (isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] == "Yes" && ($_SESSION['empNumber']!=$empNumber)) { 
                    if ($emergencyContactPermissions->canCreate()) { ?>
