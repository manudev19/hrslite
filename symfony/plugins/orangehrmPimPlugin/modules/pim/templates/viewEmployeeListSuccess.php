...
<?php $breadcrumb[]['name'] = 'Employee List';
...
<div class="head">
        <h1><?php echo __("Employee List") ?></h1>
    </div>
    <div class="inner">
        <form id="search_form" class="spinner_form" name="frmEmployeeSearch" method="post" action="<?php echo url_for('@employee_list'); ?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#btnAdd').click(function() {
            location.href = "<?php echo url_for('pim/addEmployee?1=1') ?>";
        });
