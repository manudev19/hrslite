...
class viewEmployeeListAction extends basePimAction {
    ...
    public function execute($request) {
        ...
        if( isset(  $filters['employee_name'])){
            ...
            $filters['employee_name']= str_replace('US', '', $filters['employee_name']);
            $filters['employee_name']= str_replace('CO', '',  $filters['employee_name']);
            $filters['employee_name']= trim(preg_replace("/\s*(?:[\d_]|[^\w\s])+/", "", $filters['employee_name']));
        }
        
        if (isset($filters['supervisor_name'])) {
            $filters['supervisor_name'] = str_replace(' (' . __('Past Employee') . ')', '', $filters['supervisor_name']);
            $filters['supervisor_name']= str_replace('US', '', $filters['supervisor_name']);
            $filters['supervisor_name']= str_replace('CO', '',  $filters['supervisor_name']);
            $filters['supervisor_name']= trim(preg_replace("/\s*(?:[\d_]|[^\w\s])+/", "", $filters['supervisor_name']));
        }
