...
class EmployeeService extends BaseService
{
    ...
    */
    ...
    public function getAllEmployee()
    {
        ...
        return $this->getEmployeeDao()->getAllEmployee();
    }

    public function updateEmployeesOnId(Employee $employee)
    {
        return $this->getEmployeeDao()->updateEmployeesOnId($employee);
    }
    public function saveFunctionalHead($empNumber, $functionalHead)
    {
        return $this->getEmployeeDao()->saveFunctionalHead($empNumber, $functionalHead);
    }

    public function getFunctionalHeadEmployeeList($includeTerminated = false, $orderField = 'lastName', $orderBy = 'ASC')
    {
        return $this->getEmployeeDao()->getFunctionalHeadEmployeeList($includeTerminated, $orderField, $orderBy);
    }


    public function getCandidateNumberForEmp($empId)
    {

        return $this->getEmployeeDao()->getCandidateNumberForEmp($empId);
    }
    public function getEmployeeDetail($candidate_no)
    {

        return $this->getEmployeeDao()->getEmployeeDetail($candidate_no);
    }
    public function getManagerDetail($candidate_no, $manager_id)
    {

        return $this->getEmployeeDao()->getManagerDetail($candidate_no, $manager_id);
    }
    public function getEmployeeDetailForTable($candidate_no)
    {

        return $this->getEmployeeDao()->getEmployeeDetailForTable($candidate_no);
    }

    public function updatePreonboardEmployeeForAdmin($candidate_no, $data, $manager)
    {

        return $this->getEmployeeDao()->updatePreonboardEmployeeForAdmin($candidate_no, $data, $manager);
    }
    public function updatePreonboardEmployeeForManager($data)
    {

        return $this->getEmployeeDao()->updatePreonboardEmployeeForManager($data);
    }
    public function savePreonboardEmployee($data)
    {

        return $this->getEmployeeDao()->savePreonboardEmployee($data);
    }
    public function selectPreonboardingManager($data)
    {

        return $this->getEmployeeDao()->selectPreonboardingManager($data);
    }
    public function selectPreonboardingUpdateManager($data)
    {

        return $this->getEmployeeDao()->selectPreonboardingUpdateManager($data);
    }
    public function  checkInvalidManagerName($data)
    {
        return $this->getEmployeeDao()->checkInvalidManagerName($data);
    }

    public function  checkEmployeeStatus($data)
    {

        return $this->getEmployeeDao()->checkEmployeeStatus($data);
    }
    public function  checkWorkstationNumber($data)
    {

        return $this->getEmployeeDao()->checkWorkstationNumber($data);
    }

    public function getEmployeeSubordinators($empNumber)
    {

        return $this->getEmployeeDao()->getEmployeeSubordinators($empNumber);
    }

    public function getEmpID($empNumber)
    {

        return $this->getEmployeeDao()->getEmpID($empNumber);
    }

    public function getEmpNum($empNumber)
    {
        return $this->getEmployeeDao()->getEmpNum($empNumber);
    }

    public function getEmpIDForLeave($empNumber)
    {
        return $this->getEmployeeDao()->getEmpIDForLeave($empNumber);
    }

    public function getTimsheetWeeklyTotalHours($empnumber, $startdate, $endsate, $state)
    {

        return $this->getEmployeeDao()->getTimsheetWeeklyTotalHours($empnumber, $startdate, $endsate, $state);
    }

    public function getEmpByLocationId($locationId)
    {

        return $this->getEmployeeDao()->getEmpByLocationId($locationId);
    }
    public function getEmpByLocationIdBasedOnUserRole($locationId, $employee)
    {

        return $this->getEmployeeDao()->getEmpByLocationIdBasedOnUserRole($locationId, $employee);
    }

    public function getEmployeesBySubUnitAndLocationId($subUnits, $locationId, $includeTerminatedEmployees = false)
    {
        return $this->getEmployeeDao()->getEmployeesBySubUnitAndLocationId($subUnits, $locationId, $includeTerminatedEmployees);
    }

    public function getEmployeeByDateAndTermination($frmdate, $today, $jobTitle, $subUnit)
    {
        return $this->getEmployeeDao()->getEmployeeByDateAndTermination($frmdate, $today, $jobTitle, $subUnit);
    }
    
    public function getEmployeeTerminatedEmployeeByLocation($employee, $location)
    {
        return $this->getEmployeeDao()->getEmployeeTerminatedEmployeeByLocation($employee, $location);
    }
}
