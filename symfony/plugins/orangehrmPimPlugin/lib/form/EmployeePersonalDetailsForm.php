...
class EmployeePersonalDetailsForm extends BaseForm {
    ...
    private function getPersonalInfoWidgets() {
        $widgets = array(
            ...
            'emp_confirmation' => new sfWidgetFormInputCheckbox(
                array(
                    'value_attribute_value' => '1', 
                    'default' => $this->employee->emp_confirmation
                )
            )
        );
        ...
        $checkEmpStatusConfirmation = ($this->employee->emp_confirmation != null) ? 'checked' : '';
        ...
        $widgets['emp_confirmation']->setAttribute(
            'checked', 
            $checkEmpStatusConfirmation
        );
    ...
    private function getPersonalInfoValidators() {
        ...
        $validators = array(
            ...
            'emp_confirmation' => new sfValidatorInteger(array('required' => false)),
    ...
    private function getSensitiveInfoWidgets() {
        ...
        $widgets = array('txtEmployeeId' => new sfWidgetFormInputText(),
            ...
            'emp_aadhaar_num' => new sfWidgetFormInputText(),
            'emp_pan_num' => new sfWidgetFormInputText(),
            'emp_account_num' => new sfWidgetFormInputText());
        ...
        $widgets['emp_aadhaar_num']->setAttribute('value', $this->employee->emp_aadhaar_num);
        $widgets['emp_pan_num']->setAttribute('value', $this->employee->emp_pan_num);
        $widgets['emp_account_num']->setAttribute('value', $this->employee->emp_account_num);
    ...
    private function getSensitiveInfoValidators() {
        ...
        $validators = array('txtNICNo' => new sfValidatorString(array('required' => false)),
            ...
            'emp_aadhaar_num' => new sfValidatorString(array('required' => false, 'max_length' => 64), array('max_length' => 'Aadhaar Number length exceeded 64 characters')),
            'emp_pan_num' => new sfValidatorString(array('required' => false, 'max_length' => 64), array('max_length' => 'PAN Number length exceeded 64 characters')),
            'emp_account_num' => new sfValidatorString(array('required' => false, 'max_length' => 64), array('max_length' => 'Account Number length exceeded 64 characters')),
    ...
    public function getEmployee() {
        ...
        if ($this->personalInformationPermission->canUpdate()) {
            ...
            $employee->emp_confirmation = $this->getValue('emp_confirmation');
        ...
        if ($this->canEditSensitiveInformation) {
            ...
            $employee->emp_aadhaar_num = $this->getValue('emp_aadhaar_num');
            $employee->emp_pan_num = $this->getValue('emp_pan_num');
            $employee->emp_account_num = $this->getValue('emp_account_num');
        }
