...
class EmployeeJobDetailsForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->subordintors=$this->getEmployeeSubordinate($empNumber);
        ...
        $this->setDefault('emp_confirmation', $employee->emp_confirmation);
        ...
        $this->setValidators(array(
            ...
            'contract_file' => new sfValidatorFile(array('required' => false,
                'max_size' => 50000000), array('max_size' => __(TopLevelMessages::FILE_SIZE_SAVE_FAILURE))),
...
//        asort($subUnitList);
    ...
    private function  getEmployeeSubordinate($empNumber)
    {
        $employeeService = new EmployeeService();
        $employeeService->setEmployeeDao(new EmployeeDao());
        
      $subordinators=  $employeeService->getEmployeeSubordinators($empNumber); 
