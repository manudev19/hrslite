 <?php if($backUrl == 'leave/viewMyLeaveList') { ?>
 <?php $breadcrumb['name'] = "My Leave";
       $breadcrumb['link'] = '/symfony/web/index.php/leave/viewMyLeaveList'; 
       $breadcrumbnew['name'] = "My Leave Details";
       $breadcrumbnew['link'] = null; ?>
 <?php } else { 
       $breadcrumb['name'] = "Leave List";
       $breadcrumb['link'] = '/symfony/web/index.php/leave/viewLeaveList'; 
       $breadcrumbnew['name'] = "My Leave Details";
       $breadcrumbnew['link'] = null; ?>
