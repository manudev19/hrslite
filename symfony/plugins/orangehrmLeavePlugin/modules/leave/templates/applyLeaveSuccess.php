<?php $breadcrumb[]['name']='Apply Leave' ; include_partial('core/breadcrumb_page', array('breadcrumb' => $breadcrumb));?> 
<?php
...
<div class="box" id="apply-leave">
    ...
    <div class="inner">
        ...
        <form id="frmLeaveApply" class="spinner_form" name="frmLeaveApply" method="post" action="">
            ...
            <fieldset>                
                ...
                <p>
                    <input type="button" class="searchbutton" id="applyBtn" value="<?php echo __("Apply") ?>"/>
                </p>                
            </fieldset>
