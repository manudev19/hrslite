...
<?php $var=explode('stddate/',$_SERVER['REQUEST_URI']);
$leave_id=explode('id/',$_SERVER['REQUEST_URI']);
$employeeService = new LeaveEntitlementService();
$emp_id= $employeeService->getEmployeeId($leave_id[1]);
?>
<?php if($addMode){ 
    $breadcrumb['name'] = "Add Leave Entitlement";
  $breadcrumb['link'] = null;  ?>
    <?php } else{ ?>
      <?php if($emp_id == $_SESSION['empNumber']) {
             $breadcrumb['name'] = "My Entitlements ";
  $breadcrumb['link'] = "/symfony/web/index.php/leave/viewMyLeaveEntitlements"; ?>
                <?php  $breadcrumbnew['name'] = "Edit Leave Entitlement";
  $breadcrumbnew['link'] = null;  ?>
                <?php } else if($emp_id != $_SESSION['empNumber']){
  $breadcrumb['name'] = "Employee Entitlements ";
  $breadcrumb['link'] = "/symfony/web/index.php/leave/viewMyLeaveEntitlements"; ?>
                <?php  $breadcrumbnew['name'] = "Edit Leave Entitlement";
  $breadcrumbnew['link'] = null;  ?>
                <?php } ?>
...
<div class="box" id="add-leave-entitlement">
    ...
    <div class="inner">
        ...
        <form id="frmLeaveEntitlementAdd" class="spinner_form" name="frmLeaveEntitlementAdd" method="post" action="">
