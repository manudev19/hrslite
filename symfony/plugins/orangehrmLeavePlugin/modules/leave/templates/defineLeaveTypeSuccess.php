<?php 
  $breadcrumb['name'] = "Leave Types";
  $breadcrumb['link'] = "/symfony/web/index.php/leave/leaveTypeList"; ?>
<?php $breadcrumbnew['name']= $title;
...
<div class="modal hide" id="isentitlementInfoDialog">
    <div class="modal-header">
        <a class="close" data-dismiss="modal">×</a>
        <h3><?php echo __('OrangeHRM'); ?></h3>
    </div>
    <div class="modal-body">
        <p><strong><?php echo __('Entitlement Not Required'); ?>:</strong><br/><br/>
            <?php echo __('An Employee can apply for these leaves even if he is not entitled, example : Comp Off.'); ?>
        </p>
    </div>
    <div class="modal-footer">
        <input type="button" class="btn" data-dismiss="modal" value="<?php echo __('OK'); ?>" />
