...
<div id="holiday-information" class="box toggableForm">
    ...
    <div class="inner">
        ...
        <form id="frmHolidaySearch" class="spinner_form" name="frmHolidaySearch" method="post" action="<?php echo url_for('leave/viewHolidayList') ?>" > 
            ...
            <fieldset>
                ...
                <p>
                    <input type="button" name="btnSearch" id="btnSearch" value="<?php echo __("Search") ?>" class="savebutton searchbutton" />
                </p>
...
//<![CDATA[    
    ...
    function submitPage(pageNo) {
        document.frmHolidaySearch.pageNo.value = pageNo;
        document.frmHolidaySearch.hdnAction.value = 'paging';
        document.getElementById('frmHolidaySearch').submit();
    }
//]]>    
</script>