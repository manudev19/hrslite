...
class BasicWorkSchedule implements WorkScheduleInterface {
    ...
    public function isWeekend($day, $fullDay, $subUnit) {
        return $this->getWorkWeekService()->isWeekend($day, $fullDay, $subUnit, null);
    }
    ...
    public function isHoliday($day,  $subUnit) {
        return $this->getHolidayService()->isHoliday($day , $subUnit);
    }
