...
class LeaveTypeForm extends orangehrmForm {
    ...
    public function configure() {
        ...
        $widgets = array(
            ...
            'is_entitlement_not_required' => new sfWidgetFormInputCheckbox(array('value_attribute_value' => 1)),
        ...
        $validators = array(
            ...
            'is_entitlement_not_required' => new sfValidatorBoolean(),
        ...
        $this->getWidgetSchema()->setLabel('is_entitlement_not_required', '<a id="isentitlement_link" href="#">' . __('Is Entitlement Not Required') . '</a>');
    ...
    public function setDefaultValues($leaveTypeId) {
        ...
        if ($leaveTypeObject instanceof LeaveType) {
            ...
            $this->setDefault('is_entitlement_not_required', $leaveTypeObject->getIsEntitlementNotRequired());
    ...
    public function getLeaveTypeObject() {
        ...
        $leaveType->setIsEntitlementNotRequired($this->getValue('is_entitlement_not_required'));
