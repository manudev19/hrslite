...
class LeaveBalanceReportForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidget('isDownloadable', new sfWidgetFormInputHidden(array(), array()));
	    $this->setValidator('isDownloadable', new sfValidatorString(array('required' => false)));
    ...
    protected function getFormLabels() {
        ...
        $labels = array(
            ...
            'include_terminated' => __('Show Only Past Employees')
        );
