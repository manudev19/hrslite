...
class HolidayListSearchForm extends sfForm {
    ...
    public function configure() {
        ...
        $this->setWidget('sub_unit', new ohrmWidgetSubUnitDropDown(array(), array('id' => 'sub_unit')));
        ...
        $this->setvalidators(array(
            ...
            'sub_unit'  => new sfValidatorString(array('required' => true))
            //$validators['sub_unit'] = new sfValidatorString(array('required' => false));
        ));
