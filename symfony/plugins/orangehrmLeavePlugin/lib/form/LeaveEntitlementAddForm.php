...
class LeaveEntitlementAddForm extends LeaveEntitlementForm {
    ...
    public function configure() {
        ...
        $this->setWidget('entitlement_type', new sfWidgetFormSelect(  array(
                        'choices' => array(
                            '1' => 'Add',
                            '2' => 'Accural')
                        )));
        $this->setValidator('entitlement_type', new sfValidatorNumber(array('required' => false, 'min' => 1)));          
    ...
    protected function getFormLabels() {
        ...
        $labels = array(
            ...
            'entitlement_type' => __('Entitlement Type').$requiredMarker
