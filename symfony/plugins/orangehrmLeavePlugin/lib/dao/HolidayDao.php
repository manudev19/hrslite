...
class HolidayDao extends BaseDao {
     ...
     * @return Holiday
     */
    public function readHolidayByDate($date, $subunit = null  , OperationalCountry $operationalCountry = null) {
        try {
    ...
    public function searchHolidays($startDate = null, $endDate = null, $subunit = null, $limit, $offset)
    {
        ...
        try {
            $q = Doctrine_Query::create()
                    ...
                    ->orderBy("h.date ASC LIMIT {$offset}, {$limit}");
            ...
            $holidayList = $q->execute();
            $holidayTotalList = $cq->execute();

            return [$holidayList, $holidayTotalList];
        } catch (Exception $e) {
            throw new DaoException($e->getMessage());
        }
    }
     ...
     * @return Holiday Collection
     */
    public function getFullHolidayList($sub_unit = null) {
