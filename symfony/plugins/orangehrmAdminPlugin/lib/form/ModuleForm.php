...
class ModuleForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            'hrPolicy' => new sfWidgetFormInputCheckbox(array(), array('class' => 'checkbox', 'value' => 'on')),
    ...
    protected function _getDefaultValues() {
        ...
        $modules = array('admin', 'pim', 'leave', 'time', 'attendance' , 'recruitment', 'performance', 'expense', 'hrPolicy');
