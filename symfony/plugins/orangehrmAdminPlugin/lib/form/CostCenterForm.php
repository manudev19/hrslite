 ...
 *
 */
class CostCenterForm extends BaseForm {
    ...
    public function save() {
        ...
        if (!empty($nationalityId)) {
            $costCenter = $this->getNationalityService()->getCostCenterById($nationalityId);
        } else {
            $costCenter = new CostCenter();
        }
        // var_dump($nationalityId);
         // var_dump($this->getValue('name'));
         //     exit;
        $costCenter->setName($this->getValue('name'));
        $costCenter->save();
    }

    public function getCostCenterListAsJson() {
