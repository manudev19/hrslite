...
class ProjectService extends BaseService {
	...
	/*to delete const center mapping rows- from view cost center mapping*/

	public function deleteCostCenterMapping($id) {
		return $this->projectDao->deleteCostCenterMapping($id);
	}
	...
	public function getEditCostCenterById($id) {
		return $this->projectDao->getEditCostCenterById($id);
	}


	/**
	 *
	 * Gret costCenterMapping Id by id.
	 * 
	 * @param type $projectId
	 * @return type 
	 */
	public function getSavedCostCenterById($id) {
		return $this->projectDao->getSavedCostCenterById($id);
	}
	...
	public function getCostCenterByAdmin() {
		return $this->getProjectDao()->getCostCenterByAdmin();
	}
    ...
    /*For pagination: To count the no of rows in the CostCenterMapping View Page*/
	public function getCostCenterMappingListCount() {
		return $this->getProjectDao()->getCostCenterMappingListCount();
	}
