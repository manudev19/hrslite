 ...
 */
class deleteCostCenterAction extends sfAction {
    ...
    public function execute($request) {
        ...
        if ($form->isValid()) {
            $this->getNationalityService()->deleteCostCenter($toBeDeletedIds);
            $this->getAuditLogService()->auditLogQuery('ADMIN','costCenter','Cost Center');
