<?php $breadcrumb[]['name'] = 'Data Import';
...
<div id="pimCsvImport" class="box">
    ...
    <div class="inner">
        ...
        <form name="frmPimCsvImport" id="frmPimCsvImport" class="spinner_form" method="post" action="<?php echo url_for('admin/pimCsvImport'); ?>" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <ul class="disc">
                    ...
                    <li><?php echo __("Sample CSV file") . ': '; ?>
                        <a title="<?php echo __("Download"); ?>" target="_blank" class="download" href="<?php echo url_for('admin/sampleCsvDownload'); ?>"><?php echo __("Download"); ?></a>
                    </li>
                </ul>
                ...
                <p>
                    <input type="button" class="searchbutton" name="btnSave" id="btnSave" value="<?php echo __("Upload"); ?>" />
                </p>
