...
<div id="searchProject" class="box searchForm toggableForm">
    ...
    <div class="inner">
        <form name="frmSearchProject" id="frmSearchProject" class="spinner_form" method="post" action="<?php echo url_for('admin/viewProjects'); ?>" >
            ...
            <fieldset>
                ...
                <p>
                    <input type="button" class="searchbutton" name="btnSave" id="btnSearch" value="<?php echo __("Search"); ?>"/>
