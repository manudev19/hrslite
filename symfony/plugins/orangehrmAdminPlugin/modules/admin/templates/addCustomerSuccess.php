<?php $url= explode('addCustomer',$_SERVER['REQUEST_URI']); 
  
  $breadcrumb['name'] = "Customer";
   $breadcrumb['link'] = "/symfony/web/index.php/admin/viewCustomers"; ?>
  <?php if($url['1']=='') {
    $breadcrumbnew['name'] = "Add Customer";
   $breadcrumbnew['link'] = null; ?>
 <?php } else{ 
    $breadcrumbnew['name'] = "Edit Customer";
   $breadcrumbnew['link'] = null; } 
