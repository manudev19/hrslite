...
<div id="location-information" class="box searchForm toggableForm">
    ...
    <div class="inner">
        ...
        <form name="frmSearchLocation" id="frmSearchLocation" class="spinner_form" method="post" action="<?php echo url_for('admin/viewLocations'); ?>" >
            ...
            <fieldset>
                ...
                <p>
                    <input type="button" class="addbutton searchbutton" name="btnSave" id="btnSearch" value="<?php echo __("Search"); ?>" title="<?php echo __("Search"); ?>"/>
