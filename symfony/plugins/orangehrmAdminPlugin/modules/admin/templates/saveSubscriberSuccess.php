<?php 
    $breadcrumb['name'] = "Email Subscriptions";
    $breadcrumb['link'] = "/symfony/web/index.php/admin/viewEmailNotification"; ?>

    <?php 
    if($notificationId == 1) {
        $breadcrumbnew['name']= "Leave Applications";
        $breadcrumbnew['link'] = null;
    } elseif($notificationId == 2) {
        $breadcrumbnew['name']= "Leave Assignments";
        $breadcrumbnew['link'] = null;
    } elseif($notificationId == 3) {
        $breadcrumbnew['name']= "Leave Approvals";
        $breadcrumbnew['link'] = null;
    } elseif($notificationId == 4) {
        $breadcrumbnew['name']= "Leave Cancellations";
        $breadcrumbnew['link'] = null;
    } elseif($notificationId == 5) {
        $breadcrumbnew['name']= "Leave Rejections";
        $breadcrumbnew['link'] = null;
    } ?>
