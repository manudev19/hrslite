   ...
   <?php $url= explode('saveProject',$_SERVER['REQUEST_URI']); 
  $breadcrumb['name'] = "Projects";
   $breadcrumb['link'] = "/symfony/web/index.php/admin/viewProjects"; ?>
  <?php if($url['1']=='') {
    $breadcrumbnew['name'] = "Add Project";
   $breadcrumbnew['link'] = null; ?>
 <?php } else{ 
     if (isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] == "Yes") {
    $breadcrumbnew['name'] = "Edit Project";
   $breadcrumbnew['link'] = null; ?>
    <?php } 
