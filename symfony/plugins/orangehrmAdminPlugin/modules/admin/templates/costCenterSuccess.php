...
<div id="nationality" class="box">
    ...
    <div class="head"><h1 id="nationalityHeading"><?php echo __("Add Cost Center"); ?></h1></div>
    
    <div class="inner">

        <form name="frmNationality" id="frmNationality" method="post" action="<?php echo url_for('admin/costCenter'); ?>" >
...
<script type="text/javascript">
	var nationalities = <?php echo str_replace('&#039;', "'", $form->getCostCenterListAsJson()) ?> ;
	...
	var nationalityInfoUrl = "<?php echo url_for("admin/getCostCenterJson?id="); ?>";
	var lang_editNationality = "<?php echo __("Edit Nationality"); ?>";
	var lang_addNationality = "<?php echo __("Add Cost Center"); ?>";
