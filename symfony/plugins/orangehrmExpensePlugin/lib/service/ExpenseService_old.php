...
class ExpenseService {
    ...
    */
    ...
    public function getExpense($employeeId, $fromDate, $toDate, $selectedProject,$selectedStatus,$subList,$isSup,$selectedDepartment)
    {
        return $this->getExpenseDao()->getExpense($employeeId, $fromDate, $toDate, $selectedProject, $selectedStatus,$subList,$isSup,$selectedDepartment);
    }
    public function viewAllForSup($employeeId, $fromDate, $toDate, $selectedProject,$selectedStatus,$subList,$isSup,$selectedDepartment)
    {
        return $this->getExpenseDao()->viewAllForSup($employeeId, $fromDate, $toDate, $selectedProject, $selectedStatus,$subList,$isSup,$selectedDepartment);
    }
    ...
    public function getExpenseForEmp($empId)
    {
        
        return $this->getExpenseDao()->getExpenseForEmp($empId);
    }

    public function managerApprovedExpenseForFinance($employeeId, $fromDate, $toDate, $selectedProject, $selectedStatus,$subList,$isSup,$empHeadLocId, $selectedDepartment)
    {

        return $this->getExpenseDao()->managerApprovedExpenseForFinance($employeeId, $fromDate, $toDate, $selectedProject, $selectedStatus,$subList,$isSup,$empHeadLocId, $selectedDepartment);
    }
    public function viewAllForFinanceTeam($employeeId, $fromDate, $toDate, $selectedProject,$selectedStatus,$subList,$isSup,$empHeadLocId, $selectedDepartment)
    {

        return $this->getExpenseDao()->viewAllForFinanceTeam($employeeId, $fromDate, $toDate, $selectedProject,$selectedStatus,$subList,$isSup,$empHeadLocId, $selectedDepartment);
    }
    ...
    public function managerApprovedExpenseForFinance1($employeeId, $fromDate, $toDate, $selectedProject,$selectedStatus,$subList,$isSup, $empHeadLocId, $selectedDepartment)
    {
        // var_dump($selectedDepartment);
        // exit;
        return $this->getExpenseDao()->managerApprovedExpenseForFinance1($employeeId, $fromDate, $toDate, $selectedProject, $selectedStatus, $subList, $isSup, $empHeadLocId, $selectedDepartment);
    }
