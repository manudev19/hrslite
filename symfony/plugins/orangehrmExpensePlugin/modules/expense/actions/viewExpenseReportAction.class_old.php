      ...
      if ($employee->work_station != 3 && $employee->work_station != 8 && $employee->work_station != 2 && $employee->work_station != 4 && $employee->work_station != 5 && $employee->work_station != 9 && $employee->work_station != 18 && $employee->work_station != 34 && $employee->work_station != 36 &&  $user->id!= 1 ) {
        ...
        if ($request->isMethod('post')) {
            ...
            if( 
                ...
                $result = $this->getTimesheetService()->viewAllForSup($employeeId, $fromDate, $toDate, $selectedProject,$selectedStatus,$subList,$isSup,$selectedDepartment);
                }else{
                    //IF any radio button other than all is checked!
                $result = $this->getTimesheetService()->getExpense($employeeId, $fromDate, $toDate, $selectedProject,$selectedStatus,$subList,$isSup,$selectedDepartment); 
                }
                ...
                $index = $offset+1;
                foreach ($result as $key => $expenseOfMonth) {
