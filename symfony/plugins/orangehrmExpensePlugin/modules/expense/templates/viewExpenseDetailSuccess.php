...
<?php if($data['empId'] != $loggedInEmpNumber){ 
  $breadcrumb['name'] = "View Employee Expense";
  $breadcrumb['link'] = "/symfony/web/index.php/expense/viewExpenseReport";  ?>
<?php  } else{
   $breadcrumb['name'] = "View My Expense";
   $breadcrumb['link'] = "/symfony/web/index.php/expense/viewMyExpenseReport";  

}
 $breadcrumbnew['name']='Expense Report';
...
<div class="box"><table>
  <tbody>
     ...
     <?php if($supervisor == true && $data['empId'] != $loggedInEmpNumber && $data['state'] == 'SUBMITTED') { ?>
      <div class="box">
        <div class="head" style="text-align: center;">
          <h1 >Expense Action </h1>
        </div>
        <div class="inner">
          <form id="expenseActionFrm" name="expenseActionFrm"  action="<?php echo url_for("expense/viewExpenseDetail?expenseId=".$data['expenseId']); ?>" method="post">
            ...
            <fieldset>
              ...
              <p>
                ...
                <input type="submit" class="" name="btnApprove" id="ApproveButton" value="<?php echo __('Comment & Approve') ?>" />
 ...
 <p> <input type="submit"  name="btnDownload" onclick="downloadBTN()" id="downloadbutton" value="<?php echo __("Download") ?>"  />
 <input type="button" class="backbutton" id="btnBack"
              value="<?php echo __("Cancel")?>" tabindex="13" />
 </p></form>
</div>
