...
<div class="box searchForm toggableForm">
  ...
  <div class="inner">
    ...
    <form action="<?php echo url_for("expense/applyexpense?".http_build_query(array('expenseId' => $expenseId)))?>" class="spinner_form" id="travel_expense" name="employeeSelectForm" method="post" enctype="multipart/form-data">
