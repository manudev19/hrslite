...
<?php $breadcrumb[]['name'] = 'Employee Expense Report';
...
<div class="box" id="attendance-summary">
     <div class="head"><h1><?php echo __('Employee Expense Report'); ?></h1></div> 
        <div class="inner">
         ...
         <form action="<?php echo url_for("expense/viewExpenseReport"); ?>" id="employeeSelectForm" 
         class="spinner_form" name="employeeSelectForm" method="post">
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <input type="button" class="hideden downloadBtn" onclick="downloadBTN()" id="searchBtn" value="<?php echo __("Download") ?>"  />
                </p>
            </fieldset>
...
function downloadBTN(){
    ...
    $(document).ready(function() {
        ...
        $('#resetBtn').on('click',function(){
            ...
            var url = "<?php echo url_for('expense/viewExpenseReport')?>";
            window.location = url;
        });
