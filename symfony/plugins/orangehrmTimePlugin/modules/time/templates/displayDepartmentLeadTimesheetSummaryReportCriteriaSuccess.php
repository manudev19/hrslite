     ...
     <div class="head"><h1><?php echo __('Department timesheet report'); ?></h1></div> 
        <div class="inner">
         ...
         <form action="<?php echo url_for("time/displayDepartmentLeadTimesheetSummaryReportCriteria"); ?>" id="employeeSelectForm" 
              name="employeeSelectForm" class="spinner_form" method="post">
            ...
            <fieldset>
                <ol>
                    ...
                    <li class="radio">
                            ...
                            <?php echo $form['submitted']->renderLabel(__('Not Approved')); ?>
                ...
                <p>
                    ...
                    <input type="button" onclick="downloadBTN()" id="searchBtn" class="downloadBtn" value="<?php echo __("Download") ?>"  />
                </p>
            </fieldset>
