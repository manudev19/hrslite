...
<div class="box">
    ...
    <div class="inner">
            ...
            <form action="<?php echo url_for("time/displayEmployeeReportCriteria?reportId=2"); ?>" class="spinner_form" id="reportForm" method="post">
                ...
                <li class="required">
                    ...
                    <p>
                    <input type="button" id="viewbutton" class="searchbutton" value="<?php echo __('View') ?>" />
                    </p>
