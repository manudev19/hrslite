...
<div class="box">
<div class="head">
            <h1><?php echo __("Timesheet Pending Action - Search By Department"); ?></h1>
        </div>
    <div class="inner">
        <form action="<?php echo url_for("time/viewDepartmentTimesheet"); ?>" id="departmentSelectForm" 
        class="spinner_form" name="departmentSelectForm" method="post">
        ...
        <?php if ($pager->haveToPaginate()):?>
            ...
            <form action="<?php echo url_for("time/viewDepartmentTimesheet"); ?>" id="viewTimesheetForm" method="post" >        
                <table class="table">
                    ...
                    $pendingApprovelTimesheet['timesheetStartday']. '&timeSheetAction=viewDepartmentTimesheet'
                    ;
                            ?>" id="viewSubmitted">
                                <?php echo __("View"); ?>
                            </a>
...
<script type="text/javascript">
    ...
    function submitPage(pageNo) {
        var actionUrl = $('#departmentSelectForm').attr('action') + '?pageNo=' + pageNo;
        $('#departmentSelectForm').attr('action', actionUrl).submit();
    }
