...
<div class="box" id="attendance-summary">
       <div class="head"><h1><?php echo __('Attendance Total Summary Report'); ?></h1></div>
        ...
        <form action="<?php echo url_for("time/displayAttendanceSummaryReport?reportId=" . $reportId); ?>" id="attendanceTotalSummaryReportForm" class="spinner_form" method="post">
            
            <fieldset>
                <ol>
                                                                   
                    <li> 
                        <label><?php echo __('Employee Name/Id'.' <em>*</em>') ?></label>
                ...
                <p>
                    <input type="submit" id="viewbutton" class="searchbutton" value="<?php echo __('View') ?>" />
