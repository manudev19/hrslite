            	...
            	$offset = ($pageNumber >= 1) ? (($pageNumber - 1) * $limit) : ($request->getParameter('pageNo', 1) - 1) * $limit;
           		...
           		if( 
                    ...
                    if (!empty($employeeId)) {
                        ...
                        $this->redirect('time/displayDepartmentLeadTimesheetSummaryReportCriteria');
                        }
    ...
    */
    ...
    { 
        ...
        */
        ...
        $headerArray =array("Sl. No","Employee ID","Employee Name", "Status", "Timesheet Period","Reporting Manager","Weekly Total Hours");
        $queryResultArray = [];
        ...
        foreach ($download as $data) {
            ...
            $empID = $data->getemployeIdForTimesheet();
	        array_push($tmparray,$empID);
            ...
            $getTimsheetWeeklyTotalHours = $data->getTimsheetWeeklyTotalHours();
            array_push($tmparray,$getTimsheetWeeklyTotalHours);
