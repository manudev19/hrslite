    ...
    public function execute($request) {
        ...
        if ($this->getContext()->getUser()->hasFlash('errorMessage')) {
            ...
            if($this->timesheet->getState() == "NOT SUBMITTED" &&  $this->timesheetRows ==null){
                ...
                $this->redirect( 'time/editTimesheet?'. http_build_query(array('timesheetId'=>$this->timesheet->getTimesheetId(), 'employeeId'=> $employeeId , 'actionName' => $this->actionName,'timeSheetAction'=>  $this->timesheetActon)));
                }
