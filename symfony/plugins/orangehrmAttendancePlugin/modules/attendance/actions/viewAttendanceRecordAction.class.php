                ...
                if ($this->form->isValid()) {
                    ...
                    if (!$this->employeeId) {
                        $empData = $post['employeeName'];
                         if(empty($empData['empId'])){
                            $this->getUser()->setFlash('employeeReport.warning', __('Please Enter Valid Employee Name/Id'));
                          
                        $this->redirect('attendance/viewAttendanceRecord');
