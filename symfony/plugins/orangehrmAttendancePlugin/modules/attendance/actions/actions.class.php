...
// $this->isValid=$punchIn;
    ...
    public function executeGetRelatedAttendanceRecords($request) {
        ...
        $this->records = $this->getAttendanceService()->getEmployeeAttendanceRecord($this->employeeId, $this->month, $this->year);
    ...
    public function executeProxyPunchInPunchOut($request) {
        ...
        $param = array('timezone' => $timeZoneOffset, 'month' => $this->month, 'year' => $this->year);
