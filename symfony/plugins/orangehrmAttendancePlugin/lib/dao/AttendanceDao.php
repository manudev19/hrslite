...
class AttendanceDao {
     ...
     * @param $$employeeId,$month, $date
     * @return attendance Monthly records
     */
    public function getEmployeeAttendanceRecord($employeeId, $month, $year) {
	...
	public function getDepartmentAttendanceRecords($departmentId, $month, $year,$limit, $offset) {
  
        $query = "SELECT * FROM ohrm_attendance_record INNER JOIN hs_hr_employee on ohrm_attendance_record.employee_id = hs_hr_employee.emp_number where work_station=$departmentId and MONTH(punch_in_user_time) =$month and YEAR(punch_in_user_time) = $year /*ORDER BY  punch_in_user_time ASC*/ LIMIT $offset, $limit";

          $countQuery = "SELECT * FROM ohrm_attendance_record INNER JOIN hs_hr_employee on ohrm_attendance_record.employee_id = hs_hr_employee.emp_number where work_station=$departmentId and MONTH(punch_in_user_time) =$month and YEAR(punch_in_user_time) = $year and termination_id IS NULL group by login_date, ohrm_attendance_record.employee_id ORDER by hs_hr_employee.emp_number, hs_hr_employee.emp_lastname, hs_hr_employee.emp_middle_name,punch_in_user_time asc";
    ...
    public function getAllDepartmentAttendanceRecords($month, $year,$limit, $offset) {
        
        $query = "SELECT * FROM ohrm_attendance_record INNER JOIN hs_hr_employee on ohrm_attendance_record.employee_id = hs_hr_employee.emp_number where MONTH(punch_in_user_time) =$month and YEAR(punch_in_user_time) = $year /*ORDER BY  punch_in_user_time ASC*/ LIMIT $offset, $limit";

        $countQuery = "SELECT * FROM ohrm_attendance_record INNER JOIN hs_hr_employee on ohrm_attendance_record.employee_id = hs_hr_employee.emp_number where MONTH(punch_in_user_time) =$month and YEAR(punch_in_user_time) = $year and termination_id IS NULL group by login_date, ohrm_attendance_record.employee_id ORDER by hs_hr_employee.emp_number, hs_hr_employee.emp_lastname, hs_hr_employee.emp_middle_name,punch_in_user_time asc";
