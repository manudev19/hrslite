...
class AttendanceService {
     ...
     */
    public function getAttendanceRecord($employeeId, $month, $year) {

        return $this->getAttendanceDao()->getAttendanceRecord($employeeId, $month, $year);
    }
     ...
     * @return array of records 
     */
    public function getLastDayInMonth($month, $year) {

        if($month == '02' && ($year%4 == 0)) {
            return '29';
        }  
        $last_day = array('01' => '31', '02' => '28', '03' => '31', '04' => '30', '05' => '31', '06' => '30', '07' => '31', 
    ...
    public function getEmployeeAttendanceRecord($employeeId, $month, $year) {
        ...
        return $this->getAttendanceDao()->getEmployeeAttendanceRecord($employeeId, $month, $year);
    }
	...
	public function getDepartmentAttendanceRecords($departmentId, $month, $year,$limit, $offset) {
        ...
        return $this->getAttendanceDao()->getDepartmentAttendanceRecords($departmentId, $month, $year,$limit, $offset);
    }
    public function getAllDepartmentAttendanceRecords($month, $year,$limit, $offset) {

        return $this->getAttendanceDao()->getAllDepartmentAttendanceRecords($month, $year,$limit, $offset);
    }
