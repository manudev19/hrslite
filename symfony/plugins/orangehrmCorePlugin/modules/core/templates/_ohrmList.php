                ...
                ?>
                    ...
                    <?php 
                        ...
                        */
                                 ...
                                 if($header->getName() == "Employee ID")
                                {
                                    // $employeeId = $cell->__toString();
                                    $empId = $cell->__toString();
                                    $employeeService = new EmployeeService();
                                    $empNumber=  $employeeService->getEmpNum($empId);
                                    $employeeId=$empNumber['empNumber'];
                                    
                                }


                                $dataString = null;
                                if($header->getName() == "Timesheet Period")
                                {
                                    $url= explode('time/',$_SERVER['REQUEST_URI']);
                                    if($url['1']=='displayDepartmentLeadTimesheetSummaryReportCriteria'){
                                     $timesheetAction='deptTimesheetSummary';    
                                    }else{
                                     $timesheetAction="timesheetSummary";
                                    }
                                    $getTimesheetWeekDates = explode(" to ", $cell->__toString());
                                    $dataString = "<a href='viewPendingApprovelTimesheet?employeeId=".$employeeId."&timesheetStartday=".$getTimesheetWeekDates[0]."&timeSheetAction=".$timesheetAction."' target='_blank'>".$cell->__toString()."</a>";
                                }
                                else
                                {
                                    $dataString = $cell->__toString();
                                }
                    ?>            
<!--                                <td class="<?php //echo $header->getTextAlignmentStyle(); ?>" <?php //echo $verticalStyle;?>><?php //echo $cell->__toString(); ?></td>-->
                                
                                <td class="<?php echo $header->getTextAlignmentStyle(); ?>" <?php echo $verticalStyle;?>><?php echo $dataString; ?></td>
                    <?php
                            }
                    ?>
                        </tr>
