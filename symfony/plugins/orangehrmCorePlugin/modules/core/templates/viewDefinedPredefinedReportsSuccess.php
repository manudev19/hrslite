...
<div class="box toggableForm">
    ...
    <div class="inner" >
        <form action="<?php echo url_for("core/viewDefinedPredefinedReports"); ?>" class="spinner_form" id="searchForm" method="post">
            ...
            <fieldset>
                ...
                <p>
                   <input type="submit" class="searchBtn searchbutton" value="<?php echo __('Search') ?>" name="_search" />
