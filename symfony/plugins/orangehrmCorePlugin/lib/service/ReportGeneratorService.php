            ...
            if (!empty($matches)) {
                ...
                if (($value == '-1') || ($value == '0') || ($value == '')) {
                    ...
                    $searchString = "whereCondition" . $key;
                     ...
                     if (!empty($searchString)&&$searchString=='whereConditiontoDate') {
                          $addOneDayToEndDate=date('Y-m-d', strtotime($value . ' +1 day'));
                          $value = str_replace($key, $addOneDayToEndDate, $array[1]);
