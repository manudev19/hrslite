 ...
 */
abstract class BaseAuditLogModule extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('sunhrm_audit_modules');
        ...
        $this->hasColumn('module_name as moduleName', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             ));
