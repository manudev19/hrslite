 ...
 * @property string $emp_account_num 
 ...
 * @method string                    getEmpAccountNum()              Returns the current record's "emp_account_num" value 
 ...
 * @method Employee                  setEmpAccountNum()              Sets the current record's "emp_account_num" value
...
abstract class BaseEmployee extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
		...
		$this->hasColumn('emp_aadhaar_num', 'string', 64, array(
             'type' => 'string',
             'default' => '',
             'length' => 64,
             ));
        $this->hasColumn('emp_pan_num', 'string', 64, array(
             'type' => 'string',
             'default' => '',
             'length' => 64,
             ));
             $this->hasColumn('emp_manager_id', 'string', 50, array(
               'type' => 'string',
               'default' => '',
               'length' => 50,
               ));
           $this->hasColumn('emp_resion_of_resignation', 'string', 250, array(
               'type' => 'string',
               'default' => '',
               'length' => 150,
               ));
        $this->hasColumn('emp_account_num', 'string', 64, array(
               'type' => 'string',
               'default' => '',
               'length' => 64,
               ));
        ...
        $this->hasColumn('emp_birthday', 'date', 25, array(
             ...
             $this->hasColumn('emp_Date_of_resignation', 'date', 25, array(
               'type' => 'date',
               'length' => 25,
               ));
               $this->hasColumn('Manager_Status', 'string', 20, array(
                    'type' => 'string',
                    'length' => 20,
                    ));
             $this->hasColumn('HR_Status', 'string', 20, array(
                         'type' => 'string',
                         'length' => 20,
                         ));
        ...
        $this->hasColumn('emp_confirmation', 'integer', 1, array(
               'type' => 'integer',
               'length' => 1,
             ));
