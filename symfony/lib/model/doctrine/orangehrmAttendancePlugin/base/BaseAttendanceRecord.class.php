...
abstract class BaseAttendanceRecord extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('working_hours as workingHours', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             ));
        $this->hasColumn('over_time as overTime', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             ));
        $this->hasColumn('break_time as breakTime', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             ));
        $this->hasColumn('actual_working_hours as actualWorkingHours', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             ));
        $this->hasColumn('shift as shift', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             ));
        ...
        $this->hasColumn('state as status', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             ));
        $this->hasColumn('login_date as loginDate', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             ));
    }
