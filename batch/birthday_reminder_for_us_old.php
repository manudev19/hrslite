...
$birthdayListForCardGeneration = getBirthdayListForUs($conn, $currentDateMonthDateFormat);
...
$mailList=array(
    "1"=>[ // US People
        ...
        'USA-Alpharetta-Wishes@suntechnologies.com',
              
    ]);
         $selectedDLs = $mailList['1'];
...
$birthdaylistForTomorrow = getBirthdayListForUs($conn, $tomorrowDateMonthDateFormat);
...
if ($birthdaylistForTomorrow) {
    ...
    sendMailToHr(
        ...
        $message,
        "Birthday List for $tomorrowDate  US People",
        "HRM Admin"
    ); 
}  
else {
	$message = "<p>No Birthday celebration for $tomorrowDate  US People </p>";
	sendMailToHr(
          'hr@suntechnologies.com', 
